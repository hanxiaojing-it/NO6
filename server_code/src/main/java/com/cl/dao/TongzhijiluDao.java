...
public interface TongzhijiluDao extends BaseMapper<TongzhijiluEntity> {
	...
	List<TongzhijiluEntity> selectByFasongzhuangtai(@Param("fasongzhuangtai") Integer fasongzhuangtai);
	
	List<TongzhijiluEntity> selectByYuyuebianhao(@Param("yuyuebianhao") String yuyuebianhao);
