...
public class TongzhijiluServiceImpl extends ServiceImpl<TongzhijiluDao, TongzhijiluEntity> implements TongzhijiluService {
	...
	@Override
	public List<TongzhijiluEntity> selectByFasongzhuangtai(Integer fasongzhuangtai) {
		return baseMapper.selectByFasongzhuangtai(fasongzhuangtai);
	}

	@Override
	public List<TongzhijiluEntity> selectByYuyuebianhao(String yuyuebianhao) {
		return baseMapper.selectByYuyuebianhao(yuyuebianhao);
	}

	@Override
	public boolean updateBatchById(List<TongzhijiluEntity> list) {
